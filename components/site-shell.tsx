...
import { ArrowUp, ArrowUpRight, Mail, Menu, Search, X } from "lucide-react";
...
export function SiteShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="grain min-h-screen bg-charcoal text-cream">
      <header className="fixed inset-x-0 top-0 z-50">
        <div className="section-shell pt-5">
          <div className="relative flex items-center justify-between rounded-[2rem] border border-white/10 bg-[rgba(18,18,18,0.78)] px-4 py-3 shadow-[0_18px_50px_rgba(0,0,0,0.35)] backdrop-blur-xl md:rounded-full md:px-6">
      ...
      <AnimatePresence>
        {menuOpen ? (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[rgba(10,10,10,0.94)] px-6 pt-28 backdrop-blur-xl md:hidden"
          >
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-40 inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-[rgba(18,18,18,0.82)] text-cream shadow-[0_16px_42px_rgba(0,0,0,0.38)] backdrop-blur transition-all ${
